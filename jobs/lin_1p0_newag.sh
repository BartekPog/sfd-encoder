#!/bin/bash
#SBATCH --job-name lin_1p0_newag
#SBATCH --output job_outputs/lin_1p0_newag_%A_%a.out
...
LINE=$(awk -v i="${SLURM_ARRAY_TASK_ID}" '$1==i {print; exit}' "jobs/lin_1p0_newag_tasks.tsv")
