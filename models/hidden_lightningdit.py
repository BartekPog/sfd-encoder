...
def HiddenLightningDiT_B_1_H1(**kwargs):
    return HiddenLightningDiT(depth=12, hidden_size=768, patch_size=1, num_heads=12, num_hidden_tokens=1, **kwargs)

def HiddenLightningDiT_B_1_H16(**kwargs):
    return HiddenLightningDiT(depth=12, hidden_size=768, patch_size=1, num_heads=12, num_hidden_tokens=16, **kwargs)
...
def HiddenLightningDiT_B_1_H8_separate_embedder(**kwargs):
    return HiddenLightningDiT(depth=12, hidden_size=768, patch_size=1, num_heads=12, num_hidden_tokens=8, share_patch_embedder=False, **kwargs)

def HiddenLightningDiT_B_1_H8_hidden_pos_encoding(**kwargs):
    return HiddenLightningDiT(depth=12, hidden_size=768, patch_size=1, num_heads=12, num_hidden_tokens=8, use_per_token_encoding=False, **kwargs)
...
HiddenLightningDiT_models = {
    ...
    "HiddenLightningDiT_B_1_H8_separate_embedder": HiddenLightningDiT_B_1_H8_separate_embedder,
    "HiddenLightningDiT_B_1_H8_hidden_pos_encoding": HiddenLightningDiT_B_1_H8_hidden_pos_encoding,
    "HiddenLightningDiT_B_1_H1": HiddenLightningDiT_B_1_H1,
    "HiddenLightningDiT_B_1_H16": HiddenLightningDiT_B_1_H16,
